...
public class VulkaniumASTTransformer {
    ...
    static {
        ...
        COMPAT_REPLACEMENTS.put("MC_RENDER_STAGE_TERRAIN_SOLID", "0");
        COMPAT_REPLACEMENTS.put("MC_RENDER_STAGE_TERRAIN_TRANSLUCENT", "1");
        COMPAT_REPLACEMENTS.put("MC_RENDER_STAGE_TERRAIN_CUTOUT", "2");
        COMPAT_REPLACEMENTS.put("MC_RENDER_STAGE_ENTITIES", "3");
        COMPAT_REPLACEMENTS.put("MC_RENDER_STAGE_BLOCK_ENTITIES", "4");
        COMPAT_REPLACEMENTS.put("MC_RENDER_STAGE_HAND_SOLID", "5");
        COMPAT_REPLACEMENTS.put("MC_RENDER_STAGE_HAND_TRANSLUCENT", "6");
        COMPAT_REPLACEMENTS.put("MC_RENDER_STAGE_WEATHER", "7");
        COMPAT_REPLACEMENTS.put("MC_RENDER_STAGE_SKY", "8");
        COMPAT_REPLACEMENTS.put("MC_RENDER_STAGE_DESTROY", "9");
        COMPAT_REPLACEMENTS.put("MC_RENDER_STAGE_OUTLINE", "10");
